...
class PokemonSprites(
    ...
    override fun toString(): String {
        return "PokemonSprites(frontDefault=$frontDefault, frontShiny=$frontShiny, frontFemale=$frontFemale, " +
            "frontShinyFemale=$frontShinyFemale, backDefault=$backDefault, backShiny=$backShiny, " +
            "backFemale=$backFemale, backShinyFemale=$backShinyFemale, backGray=$backGray, " +
            "frontGray=$frontGray, backTransparent=$backTransparent, frontTransparent=$frontTransparent, " +
            "backShinyTransparent=$backShinyTransparent, frontShinyTransparent=$frontShinyTransparent, " +
            "versions=$versions, other=$other)"
    }
}
