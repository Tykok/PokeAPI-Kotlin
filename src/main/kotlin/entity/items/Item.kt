...
class Item(
    ...
    override fun toString(): String {
        return "Item(id=$id, name='$name', cost=$cost, flingPower=$flingPower, flingEffect=$flingEffect, attributes=$attributes, " +
            "category=$category, effectEntries=$effectEntries, flavorTextEntries=$flavorTextEntries, gameIndices=$gameIndices, " +
            "names=$names, sprites=$sprites, heldByPokemon=$heldByPokemon, babyTriggerFor=$babyTriggerFor, machines=$machines)"
    }
}
